...
if (isset($_POST['uname']) && isset($_POST['pass'])) {
	...
	if (!$hash) {
		header('Location: https://fall-2015.cs.utexas.edu/cs105/noel/app-iter-2/sign_in.php?redir=cancel&fail=1');
	}
	if (!password_verify($pass, $hash)) {
		header('Location: https://fall-2015.cs.utexas.edu/cs105/noel/app-iter-2/sign_in.php?redid=cancel&fail=1');
	}
...
if (!isset($_SESSION['userName']) || $_SESSION['userName'] == ' ') {
	header('Location: https://fall-2015.cs.utexas.edu/cs105/noel/app-iter-2/sign_in.php?redir=cancel');
}
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<body>
		...
		<div class="other">
			<h2> Cancel Your Listings </h2>
			<p style="font-size:80%;padding:0 0 0 0;"> Note: You cannot cancel listings that are not 'Open' </p>
			<?php
