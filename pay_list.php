...
$thisAuctionQuery = $database->prepare(<<<'SQL'
	...
	WHERE AUCTION.STATUS = 3 AND AUCTION.MAX_BIDDER = :iid;
SQL
);
$thisAuctionQuery->bindValue(':iid', $_SESSION['personId'], PDO::PARAM_INT);
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<link rel="stylesheet" href="style.css" type="text/css"/> <meta charset="utf-8" /> </head>
	<body>
		...
		<div class="other">
			...
			<ul style="border: none;">	
				...
				<input type="hidden" name="pay" value="<?= htmlspecialchars($auction['AUCTION_ID'])?>"/>
